...
const TOOL_PAGES = [
  ...
  { file: "bingo-card-maker.html", maker: "bingo", title: "Bingo Card Maker" },
...
const NO_UPLOAD_MAKERS = new Set(["place-card", "name-tracing", "bingo", "chore-chart", "word-search"]);
